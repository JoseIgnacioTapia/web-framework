...
},{"./View":"src/views/View.ts"}],"src/views/UserEdits.ts":[function(require,module,exports) {
"use strict";
...
var UserEdits_1 = require("./views/UserEdits");
...
if (root) {
  var userEdit = new UserEdits_1.UserEdit(root, user);
  userEdit.render();
  console.log(userEdit);
} else {
  throw new Error('Root element not found');
}
},{"./views/UserEdits":"src/views/UserEdits.ts","./models/User":"src/models/User.ts"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
